...
//bbPress pages structure
add_action('kleo_before_page','kleo_bbpress_pages');
 
function kleo_bbpress_pages() {
	if (is_bbpress()) {
		$bbp_sidebar = sq_option('bbpress_sidebar', 'default');
		switch ($bbp_sidebar) {
			case 'right':
				remove_action('kleo_before_content', 'kleo_sidebar');
				add_action('kleo_after_content', 'kleo_sidebar');
				add_filter('kleo_content_class', function() { return "eight"; } );
				break;
			case 'left':
			...
			case '3ll':
				...
				add_filter('kleo_content_class', function() { return "six"; } );
				add_filter('kleo_sidebar_class', function() { return "three"; });
				break;
			case '3lr':
				remove_action('kleo_after_content', 'kleo_sidebar');
				add_action('kleo_before_content', 'kleo_sidebar');
