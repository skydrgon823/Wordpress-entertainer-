...
<div id="buddypress">
	...
	<div class="page" id="register-page">
		...
		<form action="" name="signup_form" id="signup_form" class="standard-form custom" method="post"
			...
			<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
				...
				<div class="row">
					<div class="twelve columns">
						<h2 class="article-title text-center"><?php _e( 'Create an Account', 'sweetdate' ); ?></h2>
					</div><!--end twelve-->
				</div>
				...
				<div class="register-section six columns" id="basic-details-section">
					...
					<label
						for="signup_username"><?php _e( 'Username', 'buddypress' ); ?><?php _e( '(required)', 'buddypress' ); ?></label>
					<?php
					...
					<label
						for="signup_email"><?php _e( 'Email Address', 'buddypress' ); ?><?php _e( '(required)', 'buddypress' ); ?></label>
					<?php
					...
					<label
						for="signup_password"><?php _e( 'Choose a Password', 'buddypress' ); ?><?php _e( '(required)', 'buddypress' ); ?></label>
					<?php
					...
					<input type="password" name="signup_password" id="signup_password"
					       value="<?php echo( isset( $_POST['signup_password'] ) ? esc_attr( $_POST['signup_password'] ) : '' ); ?>"
					       class="sq-password-entry" <?php bp_form_field_attributes( 'password' ); ?>/>
					<div id="pass-strength-result"></div>

					<label
						for="signup_password_confirm"><?php _e( 'Confirm Password', 'buddypress' ); ?><?php _e( '(required)', 'buddypress' ); ?></label>
					<?php
					...
					<input type="password" name="signup_password_confirm" id="signup_password_confirm"
					       value="<?php echo( isset( $_POST['signup_password_confirm'] ) ? esc_attr( $_POST['signup_password_confirm'] ) : '' ); ?>"
					       class="sq-password-entry-confirm" <?php bp_form_field_attributes( 'password' ); ?>/>
				...
				<?php if ( bp_get_blog_signup_allowed() ) : ?>
					...
					<div class="register-section" id="blog-details-section">
						...
						<p><label for="signup_with_blog"><input type="checkbox" name="signup_with_blog"
						                                        id="signup_with_blog"
						...
						<div id="blog-details"
							...
							<label
								for="signup_blog_url"><?php _e( 'Blog URL', 'buddypress' ); ?><?php _e( '(required)', 'buddypress' ); ?></label>
							<?php
							...
							<label
								for="signup_blog_title"><?php _e( 'Site Title', 'buddypress' ); ?><?php _e( '(required)', 'buddypress' ); ?></label>
							<?php
							...
							<fieldset class="register-site">
								<legend
									class="label"><?php _e( 'Privacy: I would like my site to appear in search engines, and in public listings around this network.', 'buddypress' ); ?></legend>
								<?php
				...
				<div class="submit">
					<input type="submit" name="signup_submit" id="signup_submit" class="button radius pull-right"
			...
			<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
				...
				<h2 class="article-title"><?php _e( 'Sign Up Complete!', 'sweetdate' ); ?></h2>
