...
<div id="message-thread">
	...
	<?php if ( bp_thread_has_messages() ) : ?>
		...
		<p id="message-recipients">
			...
			<a class="button confirm tiny radius" href="<?php bp_the_thread_delete_link(); ?>"><?php _e( 'Delete', 'buddypress' ); ?></a>
		...
		<form id="send-reply" action="<?php bp_messages_form_action(); ?>" method="post" class="standard-form">
			...
			<div class="message-box">
				...
				<div class="message-content">
					...
					<div class="submit">
						<input type="submit" class="button small radius" name="send" value="<?php esc_attr_e( 'Send Reply', 'buddypress' ); ?>" id="send_reply_button"/>
					</div>
