...
<div id="buddypress">
	...
	<form action="<?php bp_group_creation_form_action(); ?>" method="post" id="create-group-form" class="standard-form<?php if ( !bp_is_group_creation_step( 'group-invites' ) ) echo ' custom'; ?>" enctype="multipart/form-data">
		...
		<div class="item-body" id="group-create-body">
				...
				<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
					...
					<div class="main-column">
						...
						<p>
							...
							<input type="submit" name="upload" id="upload" class="button tiny radius" value="<?php esc_attr_e( 'Upload Image', 'buddypress' ); ?>" />
			...
			<?php if ( bp_is_group_creation_step( 'group-invites' ) ) : ?>
					...
					<div class="main-column">
						...
						<?php if ( bp_group_has_invites() ) : ?>
							...
							<?php while ( bp_group_invites() ) : bp_group_the_invite(); ?>
								...
								<li class="four" id="<?php bp_group_invite_item_id(); ?>">
				...
				<?php else : ?>
					...
					<div id="message" class="alert-box">
						<?php _e( 'Once you have built up friend connections you will be able to invite others to your group.', 'buddypress' ); ?>
					</div>
			...
			<?php if ( 'crop-image' != bp_get_avatar_admin_step() ) : ?>
				...
				<div class="submit" id="previous-next">
					...
					<?php if ( !bp_is_first_group_creation_step() ) : ?>
						...
						<input type="button" value="<?php esc_attr_e( 'Back to Previous Step', 'buddypress' ); ?>" class="button radius secondary" id="group-creation-previous" name="previous" onclick="location.href='<?php bp_group_creation_previous_link(); ?>'" />
					...
					<?php if ( !bp_is_last_group_creation_step() && !bp_is_first_group_creation_step() ) : ?>
						...
						<input type="submit" class="button radius" value="<?php esc_attr_e( 'Next Step', 'buddypress' ); ?>" id="group-creation-next" name="save" />
					...
					<?php if ( bp_is_first_group_creation_step() ) : ?>
						...
						<input type="submit" value="<?php esc_attr_e( 'Create Group and Continue', 'buddypress' ); ?>" class="button radius" id="group-creation-create" name="save" />
					...
					<?php if ( bp_is_last_group_creation_step() ) : ?>
						...
						<input type="submit" value="<?php esc_attr_e( 'Finish', 'buddypress' ); ?>" class="button radius" id="group-creation-finish" name="save" />
