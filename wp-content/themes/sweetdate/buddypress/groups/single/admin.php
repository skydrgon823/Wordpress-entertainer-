...
<form action="<?php bp_group_admin_form_action(); ?>" name="group-settings-form" id="group-settings-form" class="standard-form<?php if (! bp_is_group_admin_screen( 'delete-group' ) ) echo ' custom'; ?>" method="post" enctype="multipart/form-data">
