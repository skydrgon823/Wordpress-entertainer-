...
if (!class_exists('BBoss_Global_Search_bbPress')):
	 ...
	 *
	 */
	abstract class BBoss_Global_Search_bbPress extends BBoss_Global_Search_Type {
		public $type;
		...
		function sql( $search_term, $only_totalrow_count=false ){
            ...
            return apply_filters( 
                'BBoss_Global_Search_Forums_sql', 
                $sql, 
                array( 
...
// End class BBoss_Global_Search_bbPress
